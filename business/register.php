...
<head>
    ...
    <title>CEVRA - Business Registration</title>
                        ...
                        <div class="col-lg-10 col-md-10">
                            <div class="app-top-items">
                                ...
                                <div class="app-top-right-link">
                                    Already have a business account?<a class="sidebar-register-link" href="<?php echo BASE_URL() . 'business/login.php' ?>">Sign In</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5 col-lg-6 col-md-7">
                            <div class="registration">
                                <form   method="POST" 
                                        ...
                                        data-redirect="<?php echo BASE_URL() . 'business/login.php' ?>"
                                        data-confirm="#btnSignUp">
                                    <h2 class="registration-title">Business Registration</h2>
                                    <div class="row mt-3">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group mt-4">
                                                <label class="form-label">Business Name*</label>
                                                <input class="form-control h_50" type="text" placeholder="" value="" name="name" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group mt-4">
                                ...
                                <div class="new-sign-link">
                                    Already have a business account?<a class="signup-link" href="<?php echo BASE_URL() . 'business/login.php' ?>">Sign In</a>
                                </div>
                            </div>
                        </div>
                    </div>
