    ...
    <div class="header-inner">
        <nav class="navbar navbar-expand-lg bg-barren barren-head navbar fixed-top justify-content-sm-start pt-0 pb-0 ps-lg-0 pe-2">
            <div class="container-fluid ps-0">
                ...
                <a class="navbar-brand order-1 order-lg-0 ml-lg-0 ml-2 me-auto" href="<?php echo BASE_URL() . 'business/' ?>">
                        ...
                        <li class="dropdown account-dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-account dropdown-menu-end"  aria-labelledby="accountClick">
                                ...
                                <li class="profile-link">
                                    <a href="<?php echo BASE_URL() . 'business/profile.php' ?>" class="link-item">My Profile</a>
