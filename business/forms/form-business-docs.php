    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-6">
                <div class="dialog">
                    <form method="POST" action="<?php echo BASE_URL() . 'business/process/business-docs.php' ?>"
                        ...
                        <h2 class="registration-title">Business Proof Upload</h2>
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group mt-4">
                                    <label class="form-label">Document</label>
                                    <input class="form-control h_40" name="docs" type="file" required="" accept=".pdf,">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
