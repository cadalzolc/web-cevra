...
<head>
    ...
    <title>CEVRA - Administrator</title>
                        ...
                        <div class="col-xl-5 col-lg-6 col-md-7">
                            <div class="registration">
                                <form   method="POST" 
                                        ...
                                        data-redirect="<?php echo BASE_URL() . 'admin/' ?>"
                                        data-confirm="#btnSignUp">
                                    <h2 class="registration-title">Administrator Login</h2>
                                    <div class="row mt-3">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group mt-4">
                                                <label class="form-label">Username</label>
                                                <input class="form-control h_50" type="text" placeholder="" value="" name="username" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group mt-4">
